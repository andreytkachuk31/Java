...
public interface BookingFacade {
	...
	/**
	 * Get list of events for specified day. In case nothing was found, empty
	 * list is returned.
	 * 
	 * @param day
	...
	/**
	 * Get all booked tickets for specified user. Tickets should be sorted by
	...
	/**
	 * Get all booked tickets for specified event. Tickets should be sorted in
	 * by user email in ascending order.
	 * 
	 * @param event
	 *            Event
	 * @param pageSize
