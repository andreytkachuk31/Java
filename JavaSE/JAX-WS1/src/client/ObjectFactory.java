...
public class ObjectFactory {
    ...
    private final static QName _GetHelloWorldAsString_QNAME = new QName("http://ws/", "getHelloWorldAsString");
    private final static QName _GetHelloWorldAsStringResponse_QNAME = new QName("http://ws/", "getHelloWorldAsStringResponse");
     ...
     *
     */
    @XmlElementDecl(namespace = "http://ws/", name = "getHelloWorldAsString")
     ...
     *
     */
    @XmlElementDecl(namespace = "http://ws/", name = "getHelloWorldAsStringResponse")
